...
struct pinsconfig {
	...
	static struct pinsconfig PIN86[PINS] = 
	{
		...
		{24, NOSTATUS, NOSTATUS, NOAD, NOPWM, NOPWM, MC_MODULE1, MCSIF_MODULEB, NULL}, // pin 18
		{26, NOSTATUS, NOSTATUS, NOAD, NOPWM, NOPWM, MC_MODULE1, MCSIF_MODULEB, NULL}, // pin 19
		{29, NOSTATUS, NOSTATUS, NOAD, NOPWM, NOPWM, MC_MODULE1, MCSIF_MODULEB, NULL}, // pin 20
		...
		{ 0, NOSTATUS, NOSTATUS, NOAD, NOPWM, NOPWM, MC_MODULE2, MCSIF_MODULEB, NULL}, // pin 33
		{ 2, NOSTATUS, NOSTATUS, NOAD, NOPWM, NOPWM, MC_MODULE2, MCSIF_MODULEB, NULL}, // pin 34
		{ 5, NOSTATUS, NOSTATUS, NOAD, NOPWM, NOPWM, MC_MODULE2, MCSIF_MODULEB, NULL}, // pin 35
		{22, NOSTATUS, NOSTATUS, NOAD, NOPWM, NOPWM, MC_MODULE3, MCSIF_MODULEB, NULL}, // pin 36
		{30, NOSTATUS, NOSTATUS, NOAD, NOPWM, NOPWM, MC_MODULE3, MCSIF_MODULEB, NULL}, // pin 37
		{ 6, NOSTATUS, NOSTATUS, NOAD, NOPWM, NOPWM, MC_MODULE3, MCSIF_MODULEB, NULL}, // pin 38
	...
	static struct pinsconfig PIN86[PINS] = 
	{
		...
		{0, INPUT, NOSTATUS, NOAD, NOPWM, NOPWM, MC_MODULE0, MCSIF_MODULEB, NULL}, // pin 4
		{2, INPUT, NOSTATUS, NOAD, NOPWM, NOPWM, MC_MODULE0, MCSIF_MODULEB, NULL}, // pin 5
		{5, INPUT, NOSTATUS, NOAD, NOPWM, NOPWM, MC_MODULE0, MCSIF_MODULEB, NULL}, // pin 6
		{6, INPUT, NOSTATUS, NOAD, NOPWM, NOPWM, MC_MODULE3, MCSIF_MODULEB, NULL}, // pin 7
	...
	static struct pinsconfig PIN86[PINS] = 
	{
		...
		{24, NOSTATUS, NOSTATUS, NOAD, NOPWM, NOPWM, MC_MODULE0, MCSIF_MODULEB, NULL}, // pin 4
		{26, NOSTATUS, NOSTATUS, NOAD, NOPWM, NOPWM, MC_MODULE0, MCSIF_MODULEB, NULL}, // pin 5
		{29, NOSTATUS, NOSTATUS, NOAD, NOPWM, NOPWM, MC_MODULE0, MCSIF_MODULEB, NULL}, // pin 6
		...
		{16, NOSTATUS, NOSTATUS, NOAD, NOPWM, NOPWM, MC_MODULE1, MCSIF_MODULEB, NULL}, // pin 10
		{18, NOSTATUS, NOSTATUS, NOAD, NOPWM, NOPWM, MC_MODULE1, MCSIF_MODULEB, NULL}, // pin 11
		{21, NOSTATUS, NOSTATUS, NOAD, NOPWM, NOPWM, MC_MODULE1, MCSIF_MODULEB, NULL}, // pin 12
		...
		{ 0, NOSTATUS, NOSTATUS, NOAD, NOPWM, NOPWM, MC_MODULE2, MCSIF_MODULEB, NULL}, // pin 16
		{ 2, NOSTATUS, NOSTATUS, NOAD, NOPWM, NOPWM, MC_MODULE2, MCSIF_MODULEB, NULL}, // pin 17
		{ 5, NOSTATUS, NOSTATUS, NOAD, NOPWM, NOPWM, MC_MODULE2, MCSIF_MODULEB, NULL}, // pin 18
		{30, NOSTATUS, NOSTATUS, NOAD, NOPWM, NOPWM, MC_MODULE3, MCSIF_MODULEB, NULL}, // pin 19
		{22, NOSTATUS, NOSTATUS, NOAD, NOPWM, NOPWM, MC_MODULE3, MCSIF_MODULEB, NULL}, // pin 20
		{ 6, NOSTATUS, NOSTATUS, NOAD, NOPWM, NOPWM, MC_MODULE3, MCSIF_MODULEB, NULL}, // pin 21
	...
	static int INTPINSMAP[EXTERNAL_NUM_INTERRUPTS] = {4, 5, 6, 10, 11, 12, 16, 17, 18, 19, 20, 21};
